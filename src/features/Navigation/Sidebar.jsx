...
const Sidebar = () => {
    ...
    return (
        <Box pos="fixed" left={0} top={0} bottom={0} w={{ md: "6rem", lg: "15rem" }} zIndex={1} hideBelow="md" bgColor={colorCtx.background} border={"0"} borderRight={"1px"} sx={{ borderImageSlice: 1, borderImageSource: colorCtx.gradientToBottom }}>
